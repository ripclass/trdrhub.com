...
class PortRegistry:
    ...
    # Common aliases not in UN/LOCODE data.  Kept symmetric across major
    # trade-finance jurisdictions so OCR/typo tolerance doesn't favor any
    # one country.
    MANUAL_ALIASES = {
        # Bangladesh
        "BDCGP": ["Chattogram", "Chitagong", "CTG", "Chittagong Port"],
        "BDDAC": ["Dhaka", "DAC"],
        "BDMGL": ["Mongla", "Mongla Port"],
        # United States
        ...
        # China & HK
        "CNSHA": ["Shanghai", "SH", "SHA", "Port of Shanghai"],
        "CNNGB": ["Ningbo", "NGB", "Ningbo-Zhoushan"],
        "CNSGH": ["Shenzhen", "SHZ", "Shekou", "Yantian"],
        "CNQIN": ["Qingdao", "QIN", "Tsingtao"],
        "CNTAO": ["Qingdao", "TAO"],
        "CNXAM": ["Xiamen", "XAM", "Amoy"],
        "CNTSN": ["Tianjin", "TSN", "Xingang"],
        "HKHKG": ["Hong Kong", "HK", "Hongkong", "HKSAR"],
        # East Asia
        "KRPUS": ["Busan", "Pusan", "PUS"],
        "KRINC": ["Incheon", "Inchon", "INC"],
        "JPYOK": ["Yokohama", "YOK"],
        "JPTYO": ["Tokyo", "TYO"],
        "JPKOB": ["Kobe", "KOB"],
        "JPNGO": ["Nagoya", "NGO"],
        "TWKHH": ["Kaohsiung", "KHH"],
        "TWTPE": ["Taipei", "Keelung", "TPE"],
        # Southeast Asia
        "SGSIN": ["Singapore", "SG", "Singapura", "Port of Singapore"],
        "VNSGN": ["Ho Chi Minh City", "Saigon", "SGN", "Cat Lai"],
        "VNHPH": ["Hai Phong", "Haiphong", "HPH"],
        "VNDAD": ["Da Nang", "Danang", "DAD"],
        "MYPKG": ["Port Klang", "Klang", "PKG"],
        "MYTPP": ["Tanjung Pelepas", "PTP"],
        "MYPEN": ["Penang", "Pinang", "PEN"],
        "THBKK": ["Bangkok", "BKK"],
        "THLCH": ["Laem Chabang", "LCH"],
        "PHMNL": ["Manila", "MNL", "Port of Manila"],
        "IDTPP": ["Tanjung Priok", "Jakarta", "JKT"],
        "IDSRG": ["Semarang", "SRG"],
        "IDSUB": ["Surabaya", "Tanjung Perak", "SUB"],
        # South Asia
        "INMUN": ["Mundra", "Mundra Port"],
        "INNSA": ["Nhava Sheva", "JNPT", "Jawaharlal Nehru Port"],
        "INMAA": ["Chennai", "Madras", "MAA"],
        "INBOM": ["Mumbai", "Bombay", "BOM"],
        "INCCU": ["Kolkata", "Calcutta", "CCU"],
        "INCOK": ["Cochin", "Kochi", "COK"],
        "INTUT": ["Tuticorin", "V.O. Chidambaranar", "TUT"],
        "INVIZ": ["Vizag", "Visakhapatnam", "VIZ"],
        "LKCMB": ["Colombo", "CMB", "Port of Colombo"],
        "PKKHI": ["Karachi", "KHI", "Port of Karachi"],
        "PKBQM": ["Port Qasim", "Bin Qasim", "PQM", "BQM"],
        "PKGWD": ["Gwadar", "GWD"],
        # Middle East
        "AEJEA": ["Jebel Ali", "Dubai", "Port Rashid"],
        "AEAUH": ["Abu Dhabi", "Khalifa Port", "AUH"],
        "AESHJ": ["Sharjah", "SHJ"],
        "SAJED": ["Jeddah", "Jiddah", "JED"],
        "SADMM": ["Dammam", "King Abdulaziz Port", "DMM"],
        "SARUH": ["Riyadh", "RUH"],
        "OMSLL": ["Salalah", "SLL"],
        "OMMCT": ["Muscat", "Port Sultan Qaboos", "MCT"],
        "BHKBS": ["Bahrain", "Khalifa Bin Salman", "KBS"],
        "KWKWI": ["Kuwait", "Shuwaikh", "KWI"],
        # Turkey
        "TRIST": ["Istanbul", "Istambul", "IST", "Ambarli"],
        "TRMER": ["Mersin", "MER", "Port of Mersin"],
        "TRIZM": ["Izmir", "Smyrna", "IZM", "Aliaga"],
        "TRGEM": ["Gemlik", "GEM"],
        # Europe
        "GBFXT": ["Felixstowe", "Port of Felixstowe"],
        "GBLGP": ["Liverpool", "LGP"],
        "GBSOU": ["Southampton", "SOU"],
        "GBLON": ["London", "Tilbury", "LON"],
        "NLRTM": ["Rotterdam", "RTM", "Port of Rotterdam"],
        "NLAMS": ["Amsterdam", "AMS"],
        "DEHAM": ["Hamburg", "HAM", "Port of Hamburg"],
        "DEBHV": ["Bremerhaven", "Bremen", "BHV"],
        "BEANR": ["Antwerp", "Antwerpen", "ANR"],
        "BEZEE": ["Zeebrugge", "ZEE"],
        "FRLEH": ["Le Havre", "Havre", "LEH"],
        "FRMRS": ["Marseille", "Fos", "MRS"],
        "ITGOA": ["Genoa", "Genova", "GOA"],
        "ITLIV": ["Livorno", "Leghorn", "LIV"],
        "ITNAP": ["Naples", "Napoli", "NAP"],
        "ESVLC": ["Valencia", "VLC"],
        "ESALG": ["Algeciras", "ALG"],
        "ESBCN": ["Barcelona", "BCN"],
        "PTLIS": ["Lisbon", "Lisboa", "LIS"],
        "GRPIR": ["Piraeus", "Athens", "PIR"],
        "GPPIR": ["Piraeus", "Athens", "PIR"],
        # Africa
        "EGPSD": ["Port Said", "PSD"],
        "EGALY": ["Alexandria", "ALY"],
        "EGSUZ": ["Suez", "SUZ"],
        "MACAS": ["Casablanca", "CAS"],
        "MATAN": ["Tangier", "Tanger", "TAN"],
        "ZADUR": ["Durban", "DUR"],
        "ZACPT": ["Cape Town", "CPT"],
        "ZAZBA": ["Port Elizabeth", "PLZ", "Ngqura"],
        "KEMBA": ["Mombasa", "MBA"],
        "NGAPP": ["Apapa", "Lagos", "APP"],
        "NGTCP": ["Tin Can", "Lagos", "TCP"],
        "TNRAD": ["Rades", "Tunis", "RAD"],
        # Latin America
        ...
        "CLSAI": ["San Antonio", "Valparaiso", "SAI"],
        "CLVAP": ["Valparaiso", "VAP"],
        "PECLL": ["Callao", "Lima", "CLL"],
        "COCTG": ["Cartagena", "CTG"],
        "MXZLO": ["Manzanillo", "ZLO"],
        "MXVER": ["Veracruz", "VER"],
        "MXATM": ["Altamira", "Tampico", "ATM"],
        # Australia & NZ
        "AUMEL": ["Melbourne", "MEL"],
        "AUSYD": ["Sydney", "Port Botany", "SYD"],
        "AUBNE": ["Brisbane", "BNE"],
        "AUFRE": ["Fremantle", "Perth", "FRE"],
        "NZAKL": ["Auckland", "AKL"],
        "NZTRG": ["Tauranga", "TRG"],
    }
    ...
    def _load_embedded_ports(self):
        ...
        essential = [
            ...
            # Pakistan
            ("PKKHI", "Karachi", "PK", "Pakistan"),
            ("PKBQM", "Port Qasim", "PK", "Pakistan"),
            ("PKGWD", "Gwadar", "PK", "Pakistan"),
            # Middle East
            ("AEJEA", "Jebel Ali", "AE", "United Arab Emirates"),
            ("AEAUH", "Abu Dhabi", "AE", "United Arab Emirates"),
            ("SAJED", "Jeddah", "SA", "Saudi Arabia"),
            ("SADMM", "Dammam", "SA", "Saudi Arabia"),
            ("OMSLL", "Salalah", "OM", "Oman"),
            # Turkey
            ("TRMER", "Mersin", "TR", "Turkey"),
            ("TRIZM", "Izmir", "TR", "Turkey"),
            # Morocco & North Africa
            ("MACAS", "Casablanca", "MA", "Morocco"),
            ("MATAN", "Tangier", "MA", "Morocco"),
            # Vietnam
            ("VNDAD", "Da Nang", "VN", "Vietnam"),
            # Additional India
            ("INCCU", "Kolkata", "IN", "India"),
            ("INCOK", "Cochin", "IN", "India"),
            # Africa
            ("KEMBA", "Mombasa", "KE", "Kenya"),
            ("NGAPP", "Apapa", "NG", "Nigeria"),
