        ...
        section.append(
            {
                ...
                "fact_graph_v1": doc.get("factGraphV1") or doc.get("fact_graph_v1"),
                "requirements_graph_v1": doc.get("requirementsGraphV1") or doc.get("requirements_graph_v1"),
                "extraction_lane": doc.get("extractionLane") or doc.get("extraction_lane"),
