...
def upgrade() -> None:
    ...
    # Create bank_policy_overlays table (only if it doesn't exist)
    if "bank_policy_overlays" not in existing_tables:
        op.create_table(
    ...
    # Create bank_policy_exceptions table (only if it doesn't exist)
    if "bank_policy_exceptions" not in existing_tables:
        op.create_table(
