...
def test_gold_corpus_expected_matrix_matches_live_locked_baseline() -> None:
    expected_rule_matrix = {
        ...
        "set_011_invoice_issuer_mismatch.json": ["UCP600-18A"],
...
def test_gold_corpus_false_positive_guards_cover_retired_noise() -> None:
    ...
    invoice_currency_set = _load_expected("set_021_invoice_currency_mismatch.json")
    invoice_currency_false_positives = _false_positive_rule_ids(invoice_currency_set)
    assert {
        "UCP600-18",
        "UCP600-20",
        "UCP600-28",
