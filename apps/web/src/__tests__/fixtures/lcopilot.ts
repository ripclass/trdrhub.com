...
const structuredResult: StructuredResultPayload = {
  ...
  processing_summary_v2: {
    ...
    documents_found: summary.total_documents,
    verified: summary.successful_extractions,
    warnings: 0,
    errors: summary.failed_extractions,
    successful_extractions: summary.successful_extractions,
    failed_extractions: summary.failed_extractions,
    total_issues: summary.total_issues,
    discrepancies: summary.total_issues,
    severity_breakdown: summary.severity_breakdown,
    status_counts: {
      success: summary.successful_extractions,
      warning: 0,
      error: summary.failed_extractions,
    },
    document_status: {
      success: summary.successful_extractions,
      warning: 0,
