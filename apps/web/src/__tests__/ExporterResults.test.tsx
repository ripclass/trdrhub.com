...
describe('ExporterResults', () => {
  ...
  it('keeps checklist review closed when canonical truth is clean even if stale document review metadata remains and no pack exists yet', async () => {
    const user = userEvent.setup();
    const liveLikeResults = buildValidationResults({ issues: [] });
    const staleDocumentWarnings = {
      extractionStatus: 'partial',
      status: 'warning',
      issuesCount: 0,
      extractedFields: {},
    ...
    liveLikeResults.documents = [
      ...
      },
      {
        ...
        type: 'Commercial Invoice',
        typeKey: 'commercial_invoice',
        missingRequiredFields: ['invoice_date'],
      ...
      },
      {
        ...
        type: 'Bill Of Lading',
        typeKey: 'bill_of_lading',
        missingRequiredFields: ['shipment_date'],
        ...staleDocumentWarnings,
      },
      {
        id: 'doc-pack',
      ...
      },
      {
        ...
        type: 'Insurance Certificate',
        typeKey: 'insurance_certificate',
        missingRequiredFields: ['coverage_amount'],
        ...staleDocumentWarnings,
      },
    ] as any;
    liveLikeResults.summary = {
    ...
    liveLikeResults.structured_result = {
      ...
      issues: [],
      final_verdict: 'pass',
      documents_structured: liveLikeResults.documents.map((doc: any) => ({
        ...
        missing_required_fields: doc.missingRequiredFields ?? [],
        review_required: doc.reviewRequired ?? false,
    ...
    expect(within(customsPanel).getAllByText(/^Ready$/i).length).toBeGreaterThan(0);
  });
