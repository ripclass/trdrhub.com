// Homepage hero — Phase 4 rebuild (2026-07 launch).
//
// Service-first LCopilot framing per the GTM playbook: the hero sells the
// outcome (documents checked before the bank sees them), not a tool count.
// Honesty rules: no invented user counts / accuracy stats; ISBP 821.
...
export function TRDRHeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col justify-start md:justify-center overflow-hidden bg-[#00261C]">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-48 md:pt-48 pb-20">
        <div className="text-center max-w-5xl mx-auto">

          {/* Service badge */}
          <div className="mb-10 animate-fade-in-up">
            <div className="inline-flex items-center justify-center gap-2 px-4 py-1.5 rounded-full border border-[#B2F273]/20 bg-[#B2F273]/5 backdrop-blur-sm">
              <UserCheck className="w-3.5 h-3.5 text-[#B2F273]" />
              <span className="text-[#B2F273] font-mono text-xs tracking-wider uppercase">
          ...
          {/* Main headline */}
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-[0.95] tracking-tight font-display animate-fade-in-up delay-100">
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-[#EDF5F2]/80 mb-12 max-w-3xl mx-auto leading-relaxed px-4 font-light animate-fade-in-up delay-200">
            Send your LC pack — get back a cited discrepancy report within 24 hours, every
            finding referenced to UCP 600 / ISBP 821, with the fix —
            <span className="text-[#B2F273] font-normal"> before you present to the bank.</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20 animate-fade-in-up delay-300">
            ...
            <Button
              ...
              asChild
            >
              <a href="/samples/lcopilot-sample-report.pdf" download>
          ...
          {/* Trust strip — honest, verifiable facts only */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-[#EDF5F2]/10 pt-12 animate-fade-in-up delay-500">
            <div className="text-center group hover:-translate-y-1 transition-transform duration-300">
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2 font-display group-hover:text-[#B2F273] transition-colors">24h</div>
            ...
            <div className="text-center group hover:-translate-y-1 transition-transform duration-300">
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2 font-display group-hover:text-[#B2F273] transition-colors">$29</div>
              <div className="text-xs sm:text-sm text-[#EDF5F2]/60 font-mono uppercase tracking-wider">Per pack review</div>
            </div>
            <div className="text-center group hover:-translate-y-1 transition-transform duration-300">
              <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-2 font-display group-hover:text-[#B2F273] transition-colors">100%</div>
              <div className="text-xs sm:text-sm text-[#EDF5F2]/60 font-mono uppercase tracking-wider">Refund if unhappy</div>
            </div>
          </div>
