...
export default function Login() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative flex flex-col bg-slate-950 p-6 md:p-10">
        {/* Background effects */}
        ...
        <div className="flex flex-1 items-center justify-center relative z-10">
          <div className="w-full max-w-sm">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-slate-900 border-slate-800 text-white placeholder:text-slate-500 focus:border-blue-500 focus:ring-blue-500/20"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 bg-slate-900 border-slate-800 text-white placeholder:text-slate-500 focus:border-blue-500 focus:ring-blue-500/20"
                    required
                  />
                  <Button
                    type="button"
            ...
            <Button 
              variant="outline" 
              className="w-full border-slate-800 text-slate-300 hover:bg-slate-900 hover:text-white"
              disabled
            >
      ...
      <div className="relative hidden lg:flex flex-col justify-center bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 p-12 overflow-hidden">
        {/* Background pattern */}
