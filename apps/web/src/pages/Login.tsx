...
const FEATURES = [
  { icon: FileCheck, label: "LC Pack Review" },
  { icon: Shield, label: "Sanctions Screening" },
  { icon: BarChart3, label: "CBAM Readiness" },
  { icon: Ship, label: "EUDR Readiness" },
];
      ...
      <div className="relative hidden lg:flex flex-col justify-center p-12 overflow-hidden bg-[#001E16]">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-[#EDF5F2]/60 text-lg mb-12 font-light">
            Cited discrepancy reports within 24 hours — every finding referenced to
            UCP 600 / ISBP 821, reviewed by a specialist before it ships.
          </p>
