"""Alembic environment configuration for TRDR Hub"""
...
if not database_url:
    # Fallback to settings if env vars not set
    try:
        database_url = settings.DATABASE_URL
    except Exception:
        # Last resort: use hardcoded default (should not happen in production)
