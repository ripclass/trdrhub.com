...
export const ValidationResultsSchema = z.object({
  ...
  validation_contract_v1: ValidationContractV1Schema.optional().nullable(),
  submission_eligibility: SubmissionEligibilitySchema.optional().nullable(),
  raw_submission_eligibility: SubmissionEligibilitySchema.optional().nullable(),
  effective_submission_eligibility: SubmissionEligibilitySchema.optional().nullable(),
  bank_verdict: BankVerdictSchema.optional().nullable(),
  ruleset_verdict: z.string().optional().nullable(),
  final_verdict: z.enum(['pass', 'review', 'reject']).optional().nullable(),
  submission_can_submit: z.boolean().optional(),
  submission_reasons: z.array(z.string()).optional(),
